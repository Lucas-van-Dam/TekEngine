...
void InitializeWindow(){
    glfwInit();
    window = glfwCreateWindow(SCR_WIDTH,SCR_HEIGHT,"TekEngine", NULL, NULL);
...
int main() {
    ...
    Shader litShader("LitShader.vert", "LitShader.frag");
...
// set the vertex attribute
    ...
    unsigned int diffuseMap = loadTexture(R"(C:\Users\LucasvanDam\Documents\TekEngine\Engine\Tek\Textures\container2.png)");
    unsigned int specularMap = loadTexture(R"(C:\Users\LucasvanDam\Documents\TekEngine\Engine\Tek\Textures\container2_specular.png)");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        litShader.setVec3("light.diffuse", 0.5f, 0.5f, 0.5f);
...
//    unsigned char *data = stbi_load("../Tek/Textures/container.jpg", &width, &height, &nrChannels, 0);
//    if (data)
//    {
...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
//    data = stbi_load("../Tek/Textures/awesomeface.png", &width, &height, &nrChannels, 0);
//    if (data)
//    {
...
//    else
//    {
//        Logger::getInstance().log(ERROR, "Failed to load texture");
//    }
//    stbi_image_free(data);
}